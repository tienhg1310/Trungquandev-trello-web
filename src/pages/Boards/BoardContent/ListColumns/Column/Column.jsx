...
function Column({ column }) {
  ...
  const dndKitColumnStyle = {
    ...
    transition,
    // chiều cao luôn max 100% vì nếu không sẽ lỗi kéo column ngắn qua 1 column dài. bắt buộc phải kết hợp với {...listener} ở thẻ Box chứ không phải div ngoài cùng
    height: '100%',
