...
const LINK_IMAGE = 'https://scontent.fhan15-2.fna.fbcdn.net/v/t39.30808-6/342363644_6306089476119111_2633743841400144382_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=52f669&_nc_ohc=o09pVsf8AI0AX99VI4a&_nc_ht=scontent.fhan15-2.fna&_nc_e2o=f&oh=00_AfBzUlYElI-T-yM_9kxy4xnKprhF33dyd9t9fqn5GackNA&oe=65288DCB'
        ...
        >
          ...
          >
            <Card sx={{ cursor: 'pointer', boxShadow: '0 1px 1px rgba(0,0,0,0.2)', overflow: 'unset' }}>
              <CardMedia sx={{ height: 140 }} image={LINK_IMAGE} title="green iguana" />
              <CardContent sx={{ p: 1.5, '&:last-child': { p: 1.5 } }}>
                <Typography>Tienhg2001 MERN Stack</Typography>
              </CardContent>
          ...
          >
            <Button startIcon={<AddCardOutlined />}>Add new card</Button>
            <Tooltip>
