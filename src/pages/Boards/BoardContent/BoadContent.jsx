import { DndContext, DragOverlay, closestCorners, defaultDropAnimationSideEffects, MouseSensor, PointerSensor, TouchSensor, useSensor, useSensors } from '@dnd-kit/core'
...
function BoardContent({ board }) {
    ...
    if (activeColumn._id !== overColumn._id) {
      setOrderedColumns((prevColumns) => {
        ...
        if (nextOverColumn) {
          ...
          nextOverColumn.cardsOderIds = nextOverColumn.cards.map((card) => card._id)
        }
  ...
  return (
    <DndContext sensors={mySensors} collisionDetection={closestCorners} onDragStart={handleDragStart} onDragOver={handleDragOver} onDragEnd={handleDragEnd}>
      <Box
        sx={{
